...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-gray-900/80 backdrop-blur-xl border-r border-gray-800/50 flex flex-col z-50">
      {/* Logo */}
        ...
        <div className="glass-card p-3 rounded-xl">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between text-xs">
              <span className="text-gray-500">Neo4j</span>
